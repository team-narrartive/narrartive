...
export const EnhancedGeneratedImages: React.FC<EnhancedGeneratedImagesProps> = ({ 
  ...
  if (loading) {
    return (
      <div className="w-80 border-l border-gray-300 bg-white/80 backdrop-blur-sm p-4 h-screen flex flex-col">
  ...
  return (
    <div className="w-80 border-l border-gray-300 bg-white/80 backdrop-blur-sm h-screen flex flex-col">
      {/* Header */}
          ...
          <div>
            ...
            {latestVersion && (
              <div className="space-y-3">
                {/* Generation Info */}
                <div className="p-3 bg-white/90 rounded-lg shadow-sm border border-gray-200">
                ...
                <div className="space-y-3">
                  {latestVersion.images.map((imageUrl, index) => (
                    <div key={index} className="p-2 bg-white/90 backdrop-blur-sm rounded-lg shadow-sm group hover:shadow-lg transition-all duration-300 border border-gray-200">
            ...
            <div>
              ...
              <div className="space-y-4">
                {imageVersions.slice(0, -1).reverse().map((version, versionIndex) => (
                  <div key={version.id} className="p-3 bg-white/90 rounded-lg shadow-sm border border-gray-200">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-xs text-gray-500">
