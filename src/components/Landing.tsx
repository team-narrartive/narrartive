    ...
    <>
              ...
              <div>
                <h1 
                  className="text-2xl font-sans transition-all duration-300" 
                   style={{ 
                    color: colorRevealed ? 'hsl(30, 100%, 50%)' : 'hsl(0, 0%, 0%)', // Primary orange
                    fontWeight: 900
                  }}
                >
                  NarrArtive
      ...
      >
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button 
                ...
                style={{ 
                  backgroundColor: colorRevealed ? 'hsl(30, 100%, 50%)' : 'hsl(0, 0%, 0%)', // Primary orange
                  color: 'hsl(0, 0%, 100%)',
                  borderRadius: '16px'
                }}
                onMouseEnter={(e) => {
        ...
        <section className="px-6 py-24" style={{ backgroundColor: 'hsl(0, 0%, 100%)' }}>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl max-w-2xl mx-auto font-medium" style={{ color: 'hsl(0, 0%, 46%)' }}>
        ...
        <section 
          ...
          style={{ 
            backgroundColor: colorRevealed ? 'hsl(270, 50%, 95%)' : 'hsl(0, 0%, 100%)',
            transition: 'background-color 500ms ease-in-out'
          }}
        >
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-lg md:text-xl mb-12 font-medium max-w-2xl mx-auto" style={{ color: 'hsl(0, 0%, 46%)' }}>
        ...
        <footer className="px-6 py-12 border-t" style={{ 
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="font-medium" style={{ color: 'hsl(0, 0%, 46%)' }}>
