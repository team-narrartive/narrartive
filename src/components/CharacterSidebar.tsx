...
export const CharacterSidebar: React.FC<CharacterSidebarProps> = ({ 
  ...
  if (loading) {
    return (
      <div className="w-80 bg-white/50 backdrop-blur-sm border-r border-gray-200 p-4 h-screen flex flex-col">
  ...
  return (
    <div className="w-80 bg-white/50 backdrop-blur-sm border-r border-gray-200 h-screen flex flex-col">
      {/* Header - Fixed */}
